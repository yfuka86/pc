...
void solve() {
  ...
  chmin(ans, abs(a[0] - b[0]) + absmin(a[n - 1], b) + absmin(b[n - 1], a));
  chmin(ans, abs(a[n - 1] - b[n - 1]) + absmin(a[0], b) + absmin(b[0], a));
  chmin(ans, abs(a[0] - b[n - 1]) + absmin(a[n - 1], b) + absmin(b[0], a));
  chmin(ans, abs(a[n - 1] - b[0]) + absmin(a[0], b) + absmin(b[n - 1], a));

  chmin(ans, absmin(a[0], b) + absmin(a[n - 1], b) + absmin(b[0], a) + absmin(b[n - 1], a));
