...
S op(S l, S r) {
  if (l.c00 == -1 && r.c00 == -1) return l;
  if (l.c00 == -1) return r;
  if (r.c00 == -1) return l;
  return {
    mine(l.c00 + r.c10, l.c01 + r.c00, l.c01 + r.c10),
    mine(l.c00 + r.c11, l.c01 + r.c01, l.c01 + r.c11),
    mine(l.c10 + r.c10, l.c11 + r.c00, l.c11 + r.c10),
    mine(l.c10 + r.c11, l.c11 + r.c01, l.c11 + r.c11)
  };
}
S e() { return {-1, -1, -1, -1}; }
