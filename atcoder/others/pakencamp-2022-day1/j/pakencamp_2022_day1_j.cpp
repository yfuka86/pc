...
public:
  ...
  void build() {
    ll n = g.size(), len = n * 2; in.assign(n, -1); out.assign(n, -1); par.assign(n, -1); dep.assign(len, -1); node.assign(len, -1); edge.assign(len, 0); edgec.assign(len, 0);
