...
vs dir = { "N", "NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW" };
vl bound = { 25, 155, 335, 545, 795, 1075, 1385, 1715, 2075, 2445, 2845, 3265, 100000000 };
void solve() {
  ld deg, dis; cin >> deg >> dis;
  map<ll, ll> p;
  rep(i, 13) p[bound[i] * 6] = i;

  ll di = deg * 32 / 3600;
  ll power = p.upper_bound(dis * 10)->second;
  cout << (power == 0 ? "C" : dir[(di + 1) % 32 / 2]) << " " << power << "\n";
}
