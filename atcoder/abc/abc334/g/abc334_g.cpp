  ...
  rep(i, h) rep(j, w) {
    if (s[i][j] == '#') {
      ...
      if (de == 0) {
        ...
        if (bcnt == 1) sum++;
        else if (bcnt == 3) sum += 2;
      } else if (de == 4) {
        if (bcnt == 0) {
          if (as.find(i*w+j) != as.end()) sum++;
        }
        else if (bcnt == 1) sum++;
        else if (bcnt == 2) sum += 2;
        else if (bcnt == 4) sum += 3;
      }
    }
  }
